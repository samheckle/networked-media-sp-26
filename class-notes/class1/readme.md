...
4. [Tutorial: HTML Basics](#tutorial-html-basics)

## [Syllabus](https://docs.google.com/document/d/1wGJ8vOVKyxkoRgWIzEq9Xh7tauG6DFqsQ3uqaQIoKsg/edit?usp=drive_link)

### Class Expectations

1. Try your best
2. Experiment with cool stuff
3. Reach out if you have any problems
4. Follow along with class demos
...
[Defense Advanced Research Projects Agency](https://en.wikipedia.org/wiki/DARPA) "expands techology and science, and able to reach far beyond immediate military requirements". This includes Moderna's COVID vaccine, weather satellites, GPS, drones, stealth technology, the **_personal computer and the internet_**.
...
- `<head>...</head>` Head of page, not actual content; Contains _metadata_ about your page.
...
To place an image in a page, you use a URL in the src attribute of the img tag:
    ...
    <img src="https://github.com/samheckle/code-toolkit-fa-25/blob/main/images/week_01/works_cited.png" />
...
You can control the dimensions of the image by using the `width` and/or `height` attributes on the image tag:
    ...
    <img src="https://github.com/samheckle/code-toolkit-fa-25/blob/main/images/week_01/works_cited.png" width="500" />
    <!-- or -->
    <img src="https://github.com/samheckle/code-toolkit-fa-25/blob/main/images/week_01/works_cited.png" height="500" />
    <!-- or -->
    <img src="https://github.com/samheckle/code-toolkit-fa-25/blob/main/images/week_01/works_cited.png" width="500" height="500" />
