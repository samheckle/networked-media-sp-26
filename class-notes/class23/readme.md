...
5 minutes: without talking to the other person, write notes and feedback about their concept and sketch.
...
```html
HTTP/2.0 200 OK Content-Type: text/html Set-Cookie: yummy_cookie=choco
...
```html
GET /sample_page.html HTTP/2.0 Host: www.example.org Cookie: yummy_cookie=choco;
